...
fun androidx.fragment.app.Fragment.dp2px(dpValue: Float): Int {
    return context!!.dp2px(dpValue)
}

fun androidx.fragment.app.Fragment.px2dp(pxValue: Float): Int {
    return context!!.px2dp(pxValue)
}

fun androidx.fragment.app.Fragment.sp2px(dpValue: Float): Int {
    return context!!.sp2px(dpValue)
}

fun androidx.fragment.app.Fragment.px2sp(pxValue: Float): Int {
...
fun androidx.recyclerview.widget.RecyclerView.ViewHolder.px2dp(pxValue: Float): Int {
    return itemView.px2dp(pxValue)
}

fun androidx.recyclerview.widget.RecyclerView.ViewHolder.dp2px(dpValue: Float): Int {
    return itemView.dp2px(dpValue)
}

fun androidx.recyclerview.widget.RecyclerView.ViewHolder.sp2px(dpValue: Float): Int {
    return itemView.sp2px(dpValue)
}

fun androidx.recyclerview.widget.RecyclerView.ViewHolder.px2sp(pxValue: Float): Int {
...
fun androidx.fragment.app.Fragment.createDrawable(color: Int = Color.TRANSPARENT, radius: Float = 0f,
                                                  strokeColor: Int = Color.TRANSPARENT, strokeWidth: Int = 0,
                                                  enableRipple: Boolean = true,
                                                  rippleColor: Int = Color.parseColor("#88999999")): Drawable {
...
fun androidx.recyclerview.widget.RecyclerView.ViewHolder.createDrawable(color: Int = Color.TRANSPARENT, radius: Float = 0f,
                                                                        strokeColor: Int = Color.TRANSPARENT, strokeWidth: Int = 0,
                                                                        enableRipple: Boolean = true,
                                                                        rippleColor: Int = Color.parseColor("#88999999")): Drawable {
...
fun androidx.fragment.app.Fragment.toast(msg: CharSequence) {
    context?.toast(msg)
}

fun androidx.fragment.app.Fragment.longToast(msg: CharSequence) {
...
fun androidx.fragment.app.Fragment.windowWidth(): Int {
    return context!!.windowWidth()
}

fun androidx.fragment.app.Fragment.windowHeight(): Int {
...
fun androidx.recyclerview.widget.RecyclerView.ViewHolder.windowWidth(): Int {
    return itemView.windowWidth()
}

fun androidx.recyclerview.widget.RecyclerView.ViewHolder.windowHeight(): Int {
