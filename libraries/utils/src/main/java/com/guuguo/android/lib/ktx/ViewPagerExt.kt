...
import com.guuguo.android.lib.ktx.dp2px
 ...
 * 给ViewPager绑定数据
 */
fun androidx.viewpager.widget.ViewPager.bind(count: Int, bindView: (container: ViewGroup, position: Int) -> View): androidx.viewpager.widget.ViewPager {
 ...
 */
fun androidx.viewpager.widget.ViewPager.bindFragment(fm: androidx.fragment.app.FragmentManager, fragments: List<androidx.fragment.app.Fragment>, pageTitles: List<String>? = null): androidx.viewpager.widget.ViewPager {
 ...
 */
fun androidx.viewpager.widget.ViewPager.asCard(pageMargin: Int = dp2px(30.toFloat()), padding: Int = dp2px(45.toFloat())): androidx.viewpager.widget.ViewPager {
...
class CardPagerTransformer(context: Context) : androidx.viewpager.widget.ViewPager.PageTransformer {
