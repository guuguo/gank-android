 ...
 */
class SPreference<T>( var default: T, var typeToken: TypeToken<T>? = null) : ReadWriteProperty<Any?, T> {
    ...
    val prefs by lazy {
        Utils.getContext().getSharedPreferences(appName, Context.MODE_PRIVATE)
    }
    var mValue: T? = null
    ...
    private fun <U> findPreference(name: String, default: U): U = with(prefs) {
        val res: Any? = when (default) {
            ...
            is Float -> getFloat(name, default)
                ...
                if (typeToken != null) {
                    com.guuguo.android.lib.utils.SPreference.Companion.gson.fromJson<U>(getString(name, ""), typeToken!!.type) ?: default
                } else {
    ...
    private fun putPreference(name: String, value: T) = with(prefs.edit())
    {
        when (value) {
            ...
            is Float -> putFloat(name, value)
                ...
                putString(name, com.guuguo.android.lib.utils.SPreference.Companion.gson.toJson(value))
            }
        }.apply()
    }
}