...
class GankAdapter : BaseSectionQuickAdapter<GankSection, BaseViewHolder> {
    ...
    constructor() : super(R.layout.item_gank_search, R.layout.item_gank, null)

    constructor(data: List<GankSection>?) : super(R.layout.item_gank_search, R.layout.item_gank, data)
